  ...
  const trackRecord = [
    {
      ...
      sub: "Symmetrical triangle patterns signal indecision&mdash;Will Bitcoin, Ethereum, and Ripple follow the Dow's lead?",
      link:
    ...
    },
    {
      ...
      sub:
        "Bitcoin (BTC) has fallen over 10% from its $96,400 impact point, breaking the crucial $90,320 support zone within two days and reaching the initial target at $87,200&mdash;a major support level from November 2024.",
      link:
    ...
    },
    {
      ...
      sub:
        "As the US dollar teeters on long-term support, yields flash warnings, and USD/JPY unravels, bitcoin's structure points to a reversal&mdash;and a potential role alongside gold as a global safe-haven asset.",
      link:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 py-20 lg:py-28">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-[var(--muted)] max-w-xl">
              ...
              Bonds&mdash;engineered to track the major players&rsquo; footprint from monthly
              down to 1-minute.
            </p>
          ...
          <div className="mt-10 lg:mt-0 lg:pl-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <StatCard icon={Telescope} title="Top-Down Flow" desc="Monthly &rarr; 1m alignment" />
  ...
  <li>TTM and flow confirmation before trigger</li>
      ...
      <section id="indicators" className="border-y border-[var(--cardBorder)] bg-[var(--bgMuted)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <h2 className="text-3xl sm:text-4xl font-semibold">Macro S&D Alpha & Beta &mdash; Indicators</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="mt-4 text-[var(--muted)]">
              ...
              Expect clarity on key levels, confluence, and invalidations&mdash;no noise, just structure.
            </p>
            <ul className="mt-6 space-y-3 text-[var(--muted)] list-disc list-inside">
              <li>London & New York sessions: execution windows</li>
              <li>Clear rules: engage at micro 1/2 (long) and 5/4 (short)</li>
              <li>&ldquo;No chase&rdquo; discipline to avoid low-quality trades</li>
            </ul>
          </div>
          <div className="rounded-2xl bg-gradient-to-br from-[var(--bgMuted)] to-[var(--bg)] p-6 border border-[var(--cardBorder)]">
            ...
            <div className="mt-3 space-y-3">
              <div className="rounded-xl bg-[var(--card)] p-4 border border-[var(--cardBorder)]">
                SPX & SPY: defended VWAP lower band; trend sustained above 2.02&ndash;2.22 band, targeting 2.96&ndash;3.73 (options context).
              </div>
              <div className="rounded-xl bg-[var(--card)] p-4 border border-[var(--cardBorder)]">
                Nasdaq Futures: micro-1 defense &rarr; micro-4 target hit; typical MacroStructure long signal (Asia &rarr; London follow-through).
              </div>
              <div className="rounded-2xl bg-[var(--card)] p-4 border border-[var(--cardBorder)]">
                Dow Futures: short micro 5&rarr;4 into micro-3; rotation long micro-1&rarr;2 on structure alignment.
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="discord" className="border-y border-[var(--cardBorder)] bg-[var(--bgMuted)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <h2 className="text-3xl sm:text-4xl font-semibold text-center">Join the Discord &mdash; Live Updates & Analysis</h2>
            ...
            <div className="rounded-2xl bg-[var(--card)] border border-[var(--cardBorder)] overflow-hidden p-0">
              {DISCORD_SERVER_ID ? (
                ...
                <div className="p-6 text-[var(--muted)] text-sm">
                  ...
                  The &ldquo;Join Discord&rdquo; button works either way.
                </div>
              )}
            </div>
          </div>
      ...
      <section id="track-record" className="border-y border-[var(--cardBorder)] bg-[var(--bgMuted)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <p className="mt-3 text-[var(--muted)] text-center max-w-2xl mx-auto">
            Years of reliable analysis &mdash; connecting fundamentals and technicals across Crypto, FX, Commodities, Stocks, Bonds, Options, Futures, and Indices.
          </p>
      ...
      <section id="trial" className="border-y border-[var(--cardBorder)] bg-[var(--bgMuted)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="mt-3 text-[var(--muted)]">
            Message <span className="font-semibold">@Rotuma</span> on TradingView with your username. We&rsquo;ll turn on access&mdash;no forms, no card, no obligations.
          </p>
      ...
      {/* Live Chart &mdash; bigger, screenshots removed */}
      <section id="live-chart" className="border-t border-[var(--cardBorder)] bg-[var(--bg)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <p className="mt-2 text-[var(--muted)]">
            ...
            (ES, NQ, YM, CL, GC, SI, ZN, ZB, 6E, DXY&hellip;).
          </p>
      ...
      <section id="videos" className="border-y border-[var(--cardBorder)] bg-[var(--bgMuted)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="mt-3 text-[var(--muted)] text-center max-w-2xl mx-auto">Coming soon &mdash; live analysis & strategy breakdowns.</p>
          <div className="mt-10 grid md:grid-cols-2 gap-8">
      ...
      <section id="about" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="mt-3 text-[var(--muted)]">
              MacroStructure has delivered reliable market analysis for years &mdash; connecting fundamentals and technicals across Crypto, FX, Commodities, Stocks, Bonds, Options, Futures, and Indices. Now, we&rsquo;re putting the same strategy directly in your hands so you can take a front-row seat at the battlefield and trade with structure, discipline, and clarity.
            </p>
          ...
          <div className="rounded-2xl bg-[var(--card)] p-6 border border-[var(--cardBorder)]">
            ...
            <div className="mt-4 space-y-4 text-sm text-[var(--muted)]">
              <p>&ldquo;The levels are there before price. It&rsquo;s like having the map.&rdquo;</p>
              <p>&ldquo;Alpha sets the frame, Beta times the strike. Clean.&rdquo;</p>
              <p>&ldquo;Finally, a rule-set that keeps me from chasing.&rdquo;</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="faq" className="border-t border-[var(--cardBorder)] bg-[var(--bg)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl bg-[var(--card)] p-5 border border-[var(--cardBorder)]"><div className="font-semibold">How do I get access?</div><div className="text-[var(--muted)] text-sm mt-2">Message @Rotuma with your TradingView username. You&rsquo;ll receive 14-day access.</div></div>
            <div className="rounded-2xl bg-[var(--card)] p-5 border border-[var(--cardBorder)]"><div className="font-semibold">What&rsquo;s included?</div><div className="text-[var(--muted)] text-sm mt-2">Alpha & Beta indicators, the 25-page guide, and regular structure notes/playbooks.</div></div>
